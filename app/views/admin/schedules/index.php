        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden min-h-[600px] flex flex-col">
                ...
                <div class="px-6 py-3 border-b border-slate-100 bg-slate-50/50 flex gap-2 overflow-x-auto">
                    <button class="px-3 py-1 rounded-full bg-white border border-slate-200 text-xs font-medium text-slate-600 shadow-sm hover:border-primary-300 hover:text-primary-600 transition-colors">Senin</button>
                    <button class="px-3 py-1 rounded-full bg-white border border-slate-200 text-xs font-medium text-slate-600 shadow-sm hover:border-primary-300 hover:text-primary-600 transition-colors">Selasa</button>
                    <button class="px-3 py-1 rounded-full bg-white border border-slate-200 text-xs font-medium text-slate-600 shadow-sm hover:border-primary-300 hover:text-primary-600 transition-colors">Rabu</button>
                    <button class="px-3 py-1 rounded-full bg-white border border-slate-200 text-xs font-medium text-slate-600 shadow-sm hover:border-primary-300 hover:text-primary-600 transition-colors">Kamis</button>
                    <button class="px-3 py-1 rounded-full bg-white border border-slate-200 text-xs font-medium text-slate-600 shadow-sm hover:border-primary-300 hover:text-primary-600 transition-colors">Jumat</button>
                </div>
                                    ...
                                    <tr class="group hover:bg-slate-50/80 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 align-top">
                                            <div class="flex flex-col gap-2">
                                                <div class="flex items-center gap-2">
                                                    <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-primary-50 text-primary-600 font-bold text-xs uppercase shadow-sm border border-primary-100">
                                                ...
                                                <div class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-slate-100 text-slate-600 text-xs font-medium border border-slate-200 w-fit">
                                        ...
                                        <td class="px-6 py-4 align-top">
                                            <div class="flex flex-col h-full">
                                                ...
                                                <div class="flex flex-wrap gap-2 mt-1">
                                                    ...
                                                    <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide bg-violet-50 text-violet-700 border border-violet-100">
                                                        Smst <?= e($schedule['semester']) ?>
                                                    </span>
                                                </div>
                                                
                                                <div class="mt-2 pt-2 border-t border-slate-100 text-xs text-slate-500 flex items-center gap-1.5">
                                        ...
                                        <td class="px-6 py-4 align-top">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div class="flex flex-col">
                                                    <span class="text-xs text-slate-400 uppercase tracking-wide font-semibold">Dosen</span>
                                                    <span class="text-sm font-medium text-slate-800 line-clamp-2" title="<?= e($schedule['lecturer']) ?>">
                                                        <?= e($schedule['lecturer']) ?>
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <td class="px-6 py-4 align-top">
                                            <div class="space-y-3">
                                                <div class="flex items-center gap-2">
                                                    <div class="w-6 h-6 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center text-[10px] font-bold border border-emerald-200 shrink-0">
                                                        A1
                                                    </div>
                                                    <span class="text-sm text-slate-700 truncate max-w-[140px]" title="<?= e($schedule['assistant']) ?>">
                                                        <?= e($schedule['assistant']) ?>
                                                    </span>
                                                </div>

                                                <?php if (!empty($schedule['assistant_2'])): ?>
                                                <div class="flex items-center gap-2">
                                                    <div class="w-6 h-6 rounded-full bg-sky-100 text-sky-700 flex items-center justify-center text-[10px] font-bold border border-sky-200 shrink-0">
                                                        A2
                                                    </div>
                                                    <span class="text-sm text-slate-700 truncate max-w-[140px]" title="<?= e($schedule['assistant_2']) ?>">
                                                        <?= e($schedule['assistant_2']) ?>
                                                    </span>
                                                </div>
                                                <?php endif; ?>
                                            </div>
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="flex flex-col items-center justify-center py-20 text-center">
                                            ...
                                            <p class="text-slate-500 max-w-sm mt-1 mb-6 text-sm">Belum ada jadwal praktikum yang ditambahkan untuk semester ini.</p>
                                            <a href="<?= url('/admin/schedules/create') ?>" class="text-primary-600 hover:text-primary-700 font-medium hover:underline text-sm flex items-center gap-1">
