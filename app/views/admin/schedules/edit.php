                    ...
                    <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="time" name="start_time" value="<?= e($schedule['start_time']) ?>" 
                                           class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 text-slate-900 text-sm rounded-xl focus:ring-2 focus:ring-primary-100 focus:border-primary-500 block transition-all" required>
                                </div>
                                <div>
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" name="course" value="<?= e($schedule['course']) ?>" 
                                       class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 text-slate-900 text-sm rounded-xl focus:ring-2 focus:ring-primary-100 focus:border-primary-500 block transition-all font-medium" required>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <input type="text" name="frequency" value="<?= e($schedule['frequency']) ?>" 
                                           class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 text-slate-900 text-sm rounded-xl focus:ring-2 focus:ring-primary-100 focus:border-primary-500 block transition-all font-mono">
                                </div>
                                <div>
                                    <label class="block mb-2 text-sm font-semibold text-slate-700">Jumlah Mahasiswa</label>
                                    <input type="number" name="participant_count" value="<?= e($schedule['participant_count']) ?>" 
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="3" 
                                          class="w-full p-4 bg-slate-50 border border-slate-200 text-slate-900 text-sm rounded-xl focus:ring-2 focus:ring-primary-100 focus:border-primary-500 block transition-all resize-none"
                                          placeholder="Catatan tambahan..."><?= e($schedule['description']) ?></textarea>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 sticky top-6">
                            ...
                            <div class="mb-6 p-4 bg-primary-50/50 rounded-xl border border-primary-100">
                                <label class="block mb-2 text-xs font-bold text-primary-700 uppercase">Dosen Pengampu *</label>
                                
                                <div class="flex items-center gap-4 mb-3">
                                    <div class="relative group shrink-0">
                                        <div class="w-12 h-12 rounded-full overflow-hidden bg-white border border-slate-200">
                                            <img src="<?= !empty($schedule['lecturer_photo']) ? e($schedule['lecturer_photo']) : 'https://ui-avatars.com/api/?name=Dosen&background=random' ?>" 
                                                 class="w-full h-full object-cover">
                                        </div>
                                    </div>
                                    <div class="w-full">
                                        <input type="text" name="lecturer" value="<?= e($schedule['lecturer']) ?>" 
                                               class="w-full px-3 py-2 bg-white border border-slate-200 text-slate-900 text-sm rounded-lg focus:ring-2 focus:ring-primary-100 block" required placeholder="Nama Dosen">
                                    </div>
                                </div>
                                
                                <label class="block text-[10px] text-slate-500 mb-1">Ganti Foto (Opsional)</label>
                            ...
                            <div class="mb-6 p-4 bg-emerald-50/50 rounded-xl border border-emerald-100">
                                <label class="block mb-2 text-xs font-bold text-emerald-700 uppercase">Asisten 1 (Utama) *</label>
                                
                                <div class="flex items-center gap-4 mb-3">
                                    <div class="w-12 h-12 rounded-full overflow-hidden bg-white border border-slate-200 shrink-0">
                                        <img src="<?= !empty($schedule['assistant_photo']) ? e($schedule['assistant_photo']) : 'https://ui-avatars.com/api/?name=A1&background=random' ?>" 
                                             class="w-full h-full object-cover">
                                    </div>
                                    <div class="w-full">
                                        <input type="text" name="assistant" value="<?= e($schedule['assistant']) ?>" 
                                               class="w-full px-3 py-2 bg-white border border-slate-200 text-slate-900 text-sm rounded-lg focus:ring-2 focus:ring-emerald-100 block" required placeholder="Nama Asisten 1">
                                    </div>
                                </div>
                            ...
                            <div class="mb-8 p-4 bg-violet-50/50 rounded-xl border border-violet-100">
                                ...
                                <div class="flex items-center gap-4 mb-3">
                                    <div class="w-12 h-12 rounded-full overflow-hidden bg-white border border-slate-200 shrink-0">
                                        <img src="<?= !empty($schedule['assistant2_photo']) ? e($schedule['assistant2_photo']) : 'https://ui-avatars.com/api/?name=A2&background=random' ?>" 
                                             class="w-full h-full object-cover">
                                    </div>
                                    <div class="w-full">
                                        <input type="text" name="assistant_2" value="<?= e($schedule['assistant_2']) ?>" 
                                               class="w-full px-3 py-2 bg-white border border-slate-200 text-slate-900 text-sm rounded-lg focus:ring-2 focus:ring-violet-100 block" placeholder="Nama Asisten 2">
                                    </div>
                                </div>
