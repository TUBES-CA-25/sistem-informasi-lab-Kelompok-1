    ...
    <main class="p-4 sm:ml-64 pt-8 transition-all duration-300">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-slate-900">Add New User</h1>
                    <p class="text-slate-500 text-sm mt-1">Create a new account and assign permissions.</p>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
                ...
                <form method="POST" action="<?= url('/admin/users/create') ?>">
                    ...
                    <div class="flex justify-center mb-8">
                        <div class="w-24 h-24 rounded-full bg-slate-100 border-4 border-white shadow-sm flex items-center justify-center text-slate-300">
                            <i class="bi bi-person-plus-fill text-4xl"></i>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="password" class="block mb-2 text-sm font-semibold text-slate-700">Password <span class="text-rose-500">*</span></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 start-0 flex items-center ps-4 pointer-events-none text-slate-400">
                                    <i class="bi bi-lock text-lg"></i>
                                </div>
                                <input type="password" name="password" id="password" minlength="6"
                                       class="w-full ps-11 pe-12 p-3 bg-slate-50 border border-slate-200 text-slate-900 text-sm rounded-xl focus:ring-2 focus:ring-primary-100 focus:border-primary-500 block transition-all placeholder:text-slate-400" 
                            ...
                            <p class="mt-2 text-xs text-slate-500 flex items-center gap-1">
                                <i class="bi bi-info-circle"></i> Min. 6 characters. Use strong combinations.
                            </p>
                        </div>

                        <div>
                            <label for="role_id" class="block mb-2 text-sm font-semibold text-slate-700">Assign Role <span class="text-rose-500">*</span></label>
                            <div class="relative">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label class="relative flex items-center p-4 bg-white border rounded-xl cursor-pointer hover:bg-slate-50 transition-all border-slate-200 has-[:checked]:border-emerald-500 has-[:checked]:bg-emerald-50/30 has-[:checked]:ring-1 has-[:checked]:ring-emerald-500">
                                    ...
                                    <input type="radio" name="status" value="active" class="hidden group" checked>
                                </label>

                                <label class="relative flex items-center p-4 bg-white border rounded-xl cursor-pointer hover:bg-slate-50 transition-all border-slate-200 has-[:checked]:border-slate-500 has-[:checked]:bg-slate-50 has-[:checked]:ring-1 has-[:checked]:ring-slate-500">
                                    <div class="flex items-center gap-3">
                                    ...
                                    <input type="radio" name="status" value="inactive" class="hidden group">
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center gap-4 mt-8 pt-6 border-t border-slate-100">
                        ...
                        <a href="<?= url('/admin/users') ?>" class="flex-1 text-slate-700 bg-white border border-slate-300 hover:bg-slate-50 hover:text-slate-900 focus:ring-4 focus:ring-slate-100 font-medium rounded-xl text-sm px-5 py-3 text-center transition-all">
                            Cancel
                        </a>
                    </div>
