                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                            ...
                            <div class="mb-5">
                                <label class="block mb-2 text-sm font-semibold text-slate-700">Link Eksternal (URL) <span class="text-rose-500">*</span></label>
                                <div class="relative">
                                ...
                                <p class="mt-2 text-xs text-slate-500">Masukkan tautan lengkap ke halaman berita atau blog terkait.</p>
                            </div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                            ...
                            <div class="mb-2">
                                <label class="flex flex-col items-center justify-center w-full h-48 border-2 border-primary-100 border-dashed rounded-xl cursor-pointer bg-primary-50/30 hover:bg-primary-50 hover:border-primary-300 transition-all group overflow-hidden relative" id="drop-zone">
                                    
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4" id="placeholder-content">
                                        <div class="w-12 h-12 bg-primary-100 text-primary-500 rounded-full flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                                            <i class="bi bi-cloud-arrow-up text-2xl"></i>
                                        </div>
                                        <p class="mb-1 text-sm font-semibold text-slate-700">Upload Thumbnail</p>
                                        <p class="text-xs text-slate-500">Klik untuk memilih atau drag gambar ke sini.</p>
                                    </div>
                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 sticky top-4">
                            ...
                            <div class="flex flex-col gap-3">
                                <button type="submit" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-semibold rounded-xl text-sm px-5 py-3 transition-all shadow-lg shadow-primary-500/30 flex justify-center items-center gap-2 group">
                                    <span>Terbitkan</span>
