    ...
    <main class="p-4 sm:ml-64 pt-8 transition-all duration-300">
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-slate-900">Dashboard Koordinator</h1>
                    <p class="text-slate-500 text-sm mt-1">Overview operasional laboratorium dan pemantauan masalah.</p>
                </div>
                ...
                <div class="flex items-center gap-3 pl-4 md:border-l md:border-slate-200">
                    <div class="text-right hidden sm:block">
                        ...
                        <p class="text-xs text-slate-500">Laboratory Coordinator</p>
                    </div>
                    <div class="w-10 h-10 rounded-full bg-violet-100 flex items-center justify-center text-violet-700 font-bold border-2 border-white shadow-sm ring-2 ring-violet-50">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="stat-label text-slate-500 text-sm font-medium mt-1">Masalah Tertunda</div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="stat-label text-slate-500 text-sm font-medium mt-1">Total Laporan</div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="stat-value text-3xl font-bold text-slate-800"><?= $statistics['total_laboratories'] ?? '-' ?></div>
                            <div class="stat-label text-slate-500 text-sm font-medium mt-1">Laboratorium Aktif</div>
                        </div>
                    </div>

                    <a href="<?= url('/admin/head-laboran') ?>" class="bg-gradient-to-br from-violet-600 to-purple-700 p-5 rounded-2xl shadow-lg shadow-violet-500/30 hover:shadow-violet-500/40 transition-all duration-300 flex flex-col justify-center items-center text-center group cursor-pointer border border-violet-500">
                        ...
                        <h3 class="text-white font-bold text-lg">Cek Staff</h3>
                        <p class="text-violet-100 text-xs mt-1">Pantau kehadiran KaLab</p>
                    </a>
                </div>
                ...
                <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
                    <div class="px-6 py-5 border-b border-slate-100 flex justify-between items-center bg-white">
                        <div class="flex items-center gap-2">
                            ...
                            <h2 class="text-lg font-bold text-slate-800">Laporan Masalah Terkini</h2>
                        </div>
                    ...
                    <div class="overflow-x-auto">
                                        ...
                                        <tr class="hover:bg-slate-50/80 transition-colors duration-150">
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <a href="<?= url('/admin/problems/' . $problem['id']) ?>"
                                                    class="inline-flex items-center justify-center px-3 py-1.5 text-xs font-medium text-slate-600 bg-slate-100 border border-transparent rounded-lg hover:bg-slate-200 transition-colors">
                                                    Detail
                                                </a>
                                            </td>
                                        </tr>
                        ...
                        <?php else: ?>
                            <div class="flex flex-col items-center justify-center py-16 text-center">
                                ...
                                <p class="text-base font-medium text-slate-600">Tidak ada masalah tertunda</p>
                                <p class="text-sm text-slate-400 mt-1">Sistem berjalan dengan optimal.</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
