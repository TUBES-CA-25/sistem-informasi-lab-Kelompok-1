                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="relative flex items-center p-4 border-2 border-slate-200 rounded-lg cursor-pointer hover:border-sky-500 transition-colors">
                            <input type="radio" name="problem_type" value="hardware" <?= $problem['problem_type'] == 'hardware' ? 'checked' : '' ?> class="sr-only peer" required>
                        ...
                        <label class="relative flex items-center p-4 border-2 border-slate-200 rounded-lg cursor-pointer hover:border-sky-500 transition-colors">
                            <input type="radio" name="problem_type" value="software" <?= $problem['problem_type'] == 'software' ? 'checked' : '' ?> class="sr-only peer" required>
                            <div class="flex items-center gap-3 peer-checked:text-sky-600">
