            ...
            <div class="relative h-[650px] md:h-[500px] overflow-hidden rounded-2xl">
                ...
                <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                    <div class="h-full flex flex-col pt-8 px-4 md:px-20">
                        ...
                        <div
                            class="w-full max-w-5xl mx-auto bg-white/10 backdrop-blur-md rounded-2xl border border-white/40 shadow-xl overflow-hidden flex-1 mb-16 relative">

                            <div class="overflow-y-auto h-full absolute inset-0 custom-scrollbar p-2">

                                <div
                                    class="grid grid-cols-12 gap-4 bg-slate-900/5 backdrop-blur-sm p-3 rounded-xl mb-2 text-xs font-bold uppercase text-slate-600 sticky top-0 z-10 hidden md:grid">
                                    <div class="col-span-2 text-center">Waktu</div>
                                    <div class="col-span-4">Mata Kuliah</div>
                                    <div class="col-span-4">Dosen</div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="schedule-row group bg-white/40 hover:bg-white/80 transition-all rounded-xl border border-white/50 p-4 md:p-3 grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 items-center shadow-sm"
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="font-mono font-bold text-slate-700 bg-white/50 px-2 py-1 rounded">
                                        ...
                                        <div class="md:col-span-4">
                                            <h3 class="font-bold text-slate-900 leading-tight">
                                                <?= e($sch['course_name']) ?></h3>
                                            <span
                                                class="inline-flex items-center gap-1 text-xs font-bold text-sky-600 mt-1">
                                                <i class="bi bi-people-fill"></i> Kelas <?= e($sch['class_code']) ?>
                                            </span>
                                        </div>

                                        <div class="md:col-span-4 flex items-center gap-3 mt-2 md:mt-0">
                                            ...
                                            <?php else: ?>
                                            <div
                                                class="w-8 h-8 rounded-full bg-slate-200 flex items-center justify-center text-[10px] font-bold text-slate-500">
                                                DS</div>
                                            <?php endif; ?>
                                            <div class="min-w-0">
                                                <p class="text-sm font-bold text-slate-800 truncate">
                                                    <?= e($sch['lecturer_name']) ?></p>
                                                <p class="text-[10px] text-slate-500">Dosen Pengampu</p>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <span
                                                class="status-badge px-3 py-1 rounded-full text-[10px] font-bold bg-slate-100 text-slate-500 border border-slate-200 shadow-sm uppercase tracking-wider">
                                                Menunggu
                                            </span>
                                        </div>
                                    </div>
        ...
        <div class="grid gap-8 md:grid-cols-3">
            ...
            <article
                ...
                <a href="<?= url('/activity/' . $news['id']) ?>" class="relative h-48 overflow-hidden block">
                    <?php
                            $imgSrc = !empty($news['image_cover']) ? $news['image_cover'] : 'https://placehold.co/600x400/e2e8f0/94a3b8?text=News';
    ...
    function updateScheduleStatus() {
        ...
        rows.forEach(row => {
            ...
            if (currentTime >= start && currentTime <= end) {
                ...
                if (badge) {
                    badge.className =
                        'status-badge px-3 py-1 rounded-full text-[10px] font-bold bg-blue-100 text-blue-700 animate-pulse border border-blue-200 uppercase tracking-wider';
                ...
                if (badge) {
                    badge.className =
                        'status-badge px-3 py-1 rounded-full text-[10px] font-bold bg-slate-200 text-slate-500 border border-slate-300 uppercase tracking-wider';
                ...
                if (badge) {
                    badge.className =
                        'status-badge px-3 py-1 rounded-full text-[10px] font-bold bg-slate-100 text-slate-500 border border-slate-200 shadow-sm uppercase tracking-wider';
