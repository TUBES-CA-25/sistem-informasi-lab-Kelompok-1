        ...
        <div class="mb-16">
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                <?php if (!empty($leaders)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <div class="w-full text-center text-slate-400 italic py-10 bg-white rounded-xl border border-dashed border-slate-300 mx-4">
        ...
        <div>
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                <?php if (!empty($staff)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <div class="w-full text-center text-slate-400 italic py-10 bg-white rounded-xl border border-dashed border-slate-300 mx-3">
...
function renderPresenceCard($person, $isLeader)
{
    ...
    // PERUBAHAN 3: Ukuran Avatar disamakan (semua pakai ukuran besar)
    $avatarSize = 'w-32 h-32 text-5xl';
?>
<div class="h-full group bg-white rounded-2xl border-t-4 <?= $cardBorder ?> shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden flex flex-col items-center relative">
    ...
    <div class="p-6 w-full text-center flex flex-col items-center flex-1">
        ...
        <div class="mb-5">
            <?php if ($isLeader): ?>
            <span class="text-sm font-bold text-amber-600 bg-amber-50 px-3 py-1 rounded-full border border-amber-100 shadow-sm">
