    ...
    <div class="max-w-screen-xl mx-auto px-4 space-y-8">
        ...
        <?php
                ...
                if ($view == 'day') {
                    ...
                    $groupTitle = getDayName($groupTitle);
                }
                ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden schedule-group">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors search-item">
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-xs text-slate-400 mt-1"><?= e($schedule['frequency'] ?? 'Mingguan') ?>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="font-bold text-slate-900 text-base"><?= e($schedule['course_name']) ?></div>
            ...
            <div class="md:hidden divide-y divide-slate-100">
                ...
                <div class="p-4 hover:bg-slate-50 transition-colors search-item">
                    ...
                    <h3 class="font-bold text-slate-900 text-lg mb-1"><?= e($schedule['course_name']) ?></h3>
                    ...
                    <div class="flex flex-wrap gap-y-1 text-sm text-slate-600 mb-3">
                        ...
                        <div class="w-full flex items-center">
                            ...
                            <span class="truncate w-10/12"><?= e($schedule['lecturer_name']) ?></span>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
