        ...
        <?php else: ?>
            ...
            <?php foreach ($groupedSchedules as $groupTitle => $items): ?>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mb-6">
                                ...
                                <?php foreach ($items as $schedule): ?>
                                    ...
                                    <tr class="hover:bg-slate-50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <<<<<<< HEAD <div class="font-bold text-slate-900"><?= $dayIndo ?>
                    </div>
                    =======
                    <?php
                                    $dayRaw = $schedule['day'] ?? '';
                    ...
                    >>>>>>> cae3696a8a558b437b1c83046cc2e504d10d9004
                        ...
                        <div class="p-4 hover:bg-slate-50 transition-colors">
                            ...
                            <div class="flex flex-wrap gap-y-1 text-sm text-slate-600 mb-3">
                                ...
                                <div class="w-full flex items-center">
                                    ...
                                    <span class="truncate w-10/12"><?= htmlspecialchars($schedule['lecturer_name'] ?? '-') ?></span>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
